                ...
                <form method="POST" action="{{ route('login.post') }}" class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <input 
                            ...
                            required
                            class="input-field text-base py-3 @error('password') border-red-500 ring-red-500 @enderror transform transition-all duration-300 hover:shadow-md focus:shadow-lg focus:scale-[1.01]"
                            placeholder="••••••••"
                        >
                        @error('password')
                            <p class="mt-2 text-sm text-red-600 animate-fadeInUp flex items-center">
